---
layout: france
title: We got the keys!
date: 2026-06-09
description: How our 'blursed' holiday turned out to be more blessing than cursed
---

What's the best way to start a post-retirement holiday? Is it:
* finding out your cycle carriers were bought for your last car, so don't fit your current car, and so you can't take bikes with you?
* getting a 40cm crack in your car windscreen days before you leave to drive to France?
* having to make TWO round trips of 120 miles to get said windscreen crack repaired due to staff sickness?
* driving 183 miles to Folkestone in the heaviest rain imaginable to get Le Shuttle?

So it felt like maybe this was a [blursed](https://en.wiktionary.org/wiki/blursed) holiday. That is, until we were in France.

The first test of this was of our *badge télépéage* from [Ulys](https://ulys.com) to deal with the pesky toll road payments which are all designed for a left-hand drive car. Now we just get a satisfying bleep and the payments get taken care of remotely. Would highly recommend. So far, so good...
...
![us outside our Eguisheim house](/img/us_bleuets.jpg)
...
* **Light fittings** - we'll need to supply our own, but there are temporary ones in until we do. A quirk of European renting from all accounts. Ikea has the answer, of course!
* **Water boiler(s)** - as the house overall is two apartments, there is a separate water heater for each. For some reason the pressure regulators tend to leak, so a bucket is under both of them to catch this excess water. As they are down in the basement it's no big deal, but we have been asked to empty these buckets every 2-3 days. However, we've inserted a clause into the handover document (with photos) to review this arrangement after a few weeks of living there to determine if a proper fix is needed.
* **House alarm** - as there is a shared entrance hall with the gîte, it adds complications with setting/turning off the alarm. The entrance hall sensor would set off the alarm unless turned off, but then we'd need to know about the movements of the gîte occupants. Solution; move the entrance hall sensor to the basement level.
* **Garage door** - on our video tour we'd asked if the garage door was electric or manual, and the landlord told us it an electric one was being installed "in June". When we saw it hadn't been changed yet we were told this was happening the next day!
...
First up was [Grand Frais](https://www.grandfrais.com/magasins/colmar-sud), which is a chain we'd not heard of. This had a fabulous range of high quality fresh food, so is likely to be our 'go to' store.

Right next door is a large [E.leclerc Drive](https://www.leclercdrive.fr) which is just a delivery outlet for their online service. It's a pretty soulless box with no entrance.

Just a small distance further is a HyperU (that's a SuperU on steroids) which has pretty much everything.

### Measuring up

We returned on Wednesday to admire the new garage door, but more importantly to measure the whole place so we can see what furniture will fit where. I'm planning to use [Floorplanner.com](https://floorplanner.com) to knock up some 3D prototypes.

That is if I can interpret this when we're back home in the UK!

![hand-written measurements on a floorplan](/img/floorplan.jpg)
...
While it was amazing to be just an hour from a proper spa, it wasn't the best, so it was great when Rachel found there was [a closer one at Badenweiller](https://www.staatsbad-badenweiler.de/en), just 40 minutes from Colmar. That takes us up to 25 on our [spa count](https://www.google.com/maps/d/edit?mid=15r1vvhSD0E1Kf0DH64y2UoK01vc&usp=sharing)!

Not only was the spa brilliant, but the town itself is a really beautiful place, with a wonderful park and a great [Festspielhaus](https://www.badenweiler-tourismus.de/de/veranstaltungen/raeumlichkeiten-1), where we took in a quick free Sunday afternoon performance.
