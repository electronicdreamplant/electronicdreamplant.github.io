...
This makes the logistics of our actual move  (the two of us and the cat) and a replacement french car a bit like the [Fox, Chicken, and Grain riddle](https://puzzles.nigelcoldwell.co.uk/fiftysix.htm) in that we need to take the cat, sell the car and buy a new one. Just not in that order.
...
Usefully we'd signed up for a webinar with the wonderful folk at [Ibanista](https://www.youtube.com/@Ibanista) and spent a good 90mins in the company of about 20 other people looking to make the same move as us.
...
We picked on [Fab French](https://www.fabfrenchinsurance.com/medical/) as an insurer as they offered a good rate and has a visa guarantee for the 1 year cover we have to get for a visa. They are also English speaking and have some nice extras as part of their package.
...
So a chunk of up-front cost for the mandatory insurance, and then an extra cost for the *Mutuelle* but hopefully costs will settle from year #2 onwards. Once we reach state pension age we can grab an [S1 form](https://www.gov.uk/guidance/healthcare-in-france-including-martinique-and-guadaloupe#s1) which should remove all extra costs and have the UK cover our costs. But that's some time away.
...
So a brief liaision with [WeBuyBooks](https://www.webuybooks.co.uk) and we shipped off 2 box loads for a modest bit of coin, leaving another 10 boxes to head to the charity shops. Job done!
...
## What's next?
We've also:
* identified our likely phone/broadband supplier, [Free Mobile](https://mobile.free.fr)
* identified things we're going to sell or scrap before moving
* checked which electricals we can continue to use (TV has the right decoder - yay!)
* booked the estate agents to visit to give us an estimate and advice about when to sell
